...
namespace nem::valve {
	...
	__forceinline int c_engine::get_tick ( ) { 
		using fn_t = int ( __thiscall* )( decltype( this ) );

		return ( *reinterpret_cast< fn_t** >( this ) )[ 208u ] ( this );
	}
	...
	__forceinline void c_engine::get_screen_size ( int& width, int& height )
	{
		using fn_t = void ( __thiscall* ) ( decltype ( this ), int&, int& );

		return ( *reinterpret_cast< fn_t** >( this ) )[ 5u ] ( this, width, height );
	}
	...
	__forceinline void c_move_helper::process_impacts( ) {
		using fn_t = void( __thiscall* )( decltype( this ) );

		return ( *reinterpret_cast< fn_t** >( this ) )[ 4u ]( this );
	}
	...
	__forceinline void prediction_t::check_moving_on_ground(
		c_entity* entity, double frame_time
	) {
		using fn_t = void( __thiscall* )(
			decltype( this ), c_entity*, double );

		return ( *reinterpret_cast< fn_t** >( this ) )[ 18u ](
			this, entity, frame_time
			);
	}
	...
	__forceinline vec3_t& c_movement::get_player_view_offset(bool ducked)
	{
		using fn_t = vec3_t&(__thiscall*) (decltype(this), bool);

		return (*reinterpret_cast <fn_t**> (this))[8u](this, ducked);
	}

	__forceinline vec3_t& c_movement::get_player_mins ( bool ducked )
	{
		using fn_t = vec3_t & ( __thiscall* ) ( decltype( this ), bool );

		return ( *reinterpret_cast < fn_t** > ( this ) )[ 6u ] ( this, ducked );
	}
	...
	__forceinline void c_cvar::con_print( const bool notify, const std::uint8_t& clr, const char* str ) {
		...
		if ( notify )
			reinterpret_cast< add_notify_t >( g_context->addresses( ).m_add_notify.get( ) )( clr, str );
	...
	__forceinline const char* c_panel::get_name ( std::uint32_t who )
	{
		using fn_t = const char* ( __thiscall* )( decltype( this ), std::uint32_t );

		return ( *reinterpret_cast< fn_t** >( this ) )[ 36u ] ( this, who );
	}
	...
	__forceinline void c_surface::start_drawing( ) {
		...
		return reinterpret_cast< fn_t >( g_context->addresses( ).m_start_drawing.get( ) )( this );
	}

	__forceinline void c_surface::finish_drawing( ) {
		using fn_t = void( __thiscall* )( decltype( this ) );

		return reinterpret_cast< fn_t >( g_context->addresses( ).m_finish_drawing.get( ) )( this );
	}
	...
	__forceinline void c_surface::add_clred_text(
		...
		return reinterpret_cast< fn_t >( g_context->addresses( ).m_add_clred_text.get( ) )(
	...
	__forceinline void c_font_mgr::calc_text_size( const unsigned long font, const wchar_t* str, int& width, int& height ) {
		...
		return reinterpret_cast< fn_t >( g_context->addresses( ).m_calc_text_size.get( ) )( this, font, str, width, height );
	}
	...
	__forceinline void c_font_mgr::set_font_glyph_set(
		...
		return reinterpret_cast< fn_t >( g_context->addresses( ).m_set_font_glyph_set.get( ) )(
	...
	__forceinline int c_debug_overlay::screen_pos ( const vec3_t& point, const vec3_t& screen )
	{
		using fn_t = int ( __thiscall* )( decltype( this ),
			const vec3_t&, const vec3_t&
			);

		return ( *reinterpret_cast< fn_t** >( this ) )[ 11u ] (
			this, point, screen
			);
	}
