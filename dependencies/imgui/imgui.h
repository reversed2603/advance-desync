...
namespace ImGui
{
    ...
    IMGUI_API bool          BeginChild(const char* str_id, int omg, const ImVec2& size = ImVec2(0,0), bool border = false, ImGuiWindowFlags flags = 0);
    IMGUI_API bool          BeginChild(ImGuiID id, int omg,const ImVec2& size = ImVec2(0,0), bool border = false, ImGuiWindowFlags flags = 0);
    ...
    IMGUI_API bool          TabButton(const char* label, int number, bool active, const ImVec2& size_arg, bool wiki_wiki);    // button
    ...
    IMGUI_API bool          ColorEdit5(const char* label, bool value, float col[4], ImGuiColorEditFlags flags = 0);
    IMGUI_API bool          ColorPicker3(const char* label, float col[3], ImGuiColorEditFlags flags = 0);
    IMGUI_API bool          ColorPicker4(const char* label, float col[4], ImGuiColorEditFlags flags = 0, const float* ref_col = NULL);
    IMGUI_API bool          ColorPicker5(const char* label, bool value, float col[4], ImGuiColorEditFlags flags = 0, const float* ref_col = NULL);
