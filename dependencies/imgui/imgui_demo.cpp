...
static void ShowDemoWindowWidgets()
{
    ...
    if (ImGui::TreeNode("Querying Status (Active/Focused/Hovered etc.)"))
    {
        ...
        if (embed_all_inside_a_child_window)
            ImGui::BeginChild("outer_child", 0, ImVec2(0, ImGui::GetFontSize() * 20), true);
        ...
        ImGui::BeginChild("child", 0, ImVec2(0, 50), true);
...
static void ShowDemoWindowLayout()
{
    ...
    if (ImGui::TreeNode("Child windows"))
    {
        ...
        // Child 1: no border, enable horizontal scrollbar
        {
            ...
            ImGui::BeginChild("ChildL", 0, ImVec2(ImGui::GetWindowContentRegionWidth() * 0.5f, 260), false, window_flags);
            for (int i = 0; i < 100; i++)
            {
        ...
        // Child 2: rounded border
        {
            ...
            ImGui::BeginChild("ChildR", 0, ImVec2(0, 260), true, window_flags);
        ...
        //   See "Widgets" -> "Querying Status (Active/Focused/Hovered etc.)" section for more details about this.
        {
            ...
            ImGui::BeginChild("Red", 0, ImVec2(200, 100), true, ImGuiWindowFlags_None);
            for (int n = 0; n < 50; n++)
    ...
    if (ImGui::TreeNode("Scrolling"))
    {
        ...
        for (int i = 0; i < 5; i++)
        {
            ...
            bool window_visible = ImGui::BeginChild(ImGui::GetID((void*)(intptr_t)i),omg, ImVec2(child_w, 200.0f), true, child_flags);
            if (ImGui::BeginMenuBar())
            {
        ...
        for (int i = 0; i < 5; i++)
        {
            ...
            bool window_visible = ImGui::BeginChild(ImGui::GetID((void*)(intptr_t)i),omg, ImVec2(-100, child_height), true, child_flags);
            if (scroll_to_off)
        ...
        ImGui::BeginChild("scrolling", 0, ImVec2(0, ImGui::GetFrameHeightWithSpacing() * 7 + 30), true, ImGuiWindowFlags_HorizontalScrollbar);
        ...
        {
            ImGui::BeginChild("scrolling", 0); // Demonstrate a trick: you can use Begin to set yourself in the context of another window (here we are already out of your child window)
        ...
        if (show_horizontal_contents_size_demo_window)
        {
            ...
            if (show_child)
            {
                ImGui::BeginChild("child", 0, ImVec2(0,0), true);
                ImGui::EndChild();
            }
            ImGui::End();
        }
...
static void ShowDemoWindowColumns()
{
    ...
    */
    ...
    if (ImGui::TreeNode("Horizontal Scrolling"))
    {
        ...
        ImGui::BeginChild("##ScrollingRegion", 0, ImVec2(0, ImGui::GetFontSize() * 20), false, ImGuiWindowFlags_HorizontalScrollbar);
        ImGui::Columns(10);
...
void ImGui::ShowStyleEditor(ImGuiStyle* ref)
{
    ...
    if (ImGui::BeginTabBar("##tabs", ImGuiTabBarFlags_None))
    {
        ...
        if (ImGui::BeginTabItem("Colors"))
        {
            ...
            ImGui::BeginChild("##colors", 0, ImVec2(0, 0), true, ImGuiWindowFlags_AlwaysVerticalScrollbar | ImGuiWindowFlags_AlwaysHorizontalScrollbar | ImGuiWindowFlags_NavFlattened);
...
static void ShowExampleMenuFile()
{
    ...
    if (ImGui::BeginMenu("Options"))
    {
        ...
        ImGui::BeginChild("child", 0, ImVec2(0, 60), true);
        for (int i = 0; i < 10; i++)
...
struct ExampleAppConsole
{
    ...
    void    Draw(const char* title, bool* p_open)
    {
        ...
        ImGui::BeginChild("ScrollingRegion", 0, ImVec2(0, -footer_height_to_reserve), false, ImGuiWindowFlags_HorizontalScrollbar); // Leave room for 1 separator + 1 InputText
...
struct ExampleAppLog
{
    ...
    void    Draw(const char* title, bool* p_open = NULL)
    {
        ...
        ImGui::Separator();
        ImGui::BeginChild("scrolling", 0, ImVec2(0,0), false, ImGuiWindowFlags_HorizontalScrollbar);
...
static void ShowExampleAppLayout(bool* p_open)
{
    ...
    if (ImGui::Begin("Example: Simple layout", p_open, ImGuiWindowFlags_MenuBar))
    {
        ...
        ImGui::BeginChild("left pane", 0, ImVec2(150, 0), true);
        for (int i = 0; i < 100; i++)
        {
            char label[128];
        ...
        // right
        ImGui::BeginGroup();
            ImGui::BeginChild("item view", 0, ImVec2(0, -ImGui::GetFrameHeightWithSpacing())); // Leave room for 1 line below us
